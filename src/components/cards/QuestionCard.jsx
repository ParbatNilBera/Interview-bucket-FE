...
import AIResponswPreview from "./AIResponswPreview";
  ...
  return (
    <>
      <div className="bg-white rounded-lg mb-4 overflow-hidden  py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group ">
        <div className="flex items-start justify-between cursor-pointer">
          ...
          <div className="flex items-center justify-end ml-4 relative">
            ...
            >
              ...
              <button
                className="flex items-center gap-2 text-xs font-medium bg-cyan-50 px-3 py-1 mr-2 rounded text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer"
                onClick={() => {
                  setisExpanded(true);
                  onLearnMore();
                }}
        ...
        >
          <div
            className="mt-4 text-green-700 bg-gray-50 px-5 py-3 rounded-lg"
            ref={contentRef}
          >
            <AIResponswPreview content={answer} />
          </div>
        </div>
      </div>
    </>
