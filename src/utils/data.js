export const CARD_BG = [
  ...
  { id: 2, bgcolor: "linear-gradient(135deg, #fef9e7 0%, #fffdd4 100%)" },
  { id: 3, bgcolor: "linear-gradient(135deg, #eaf7ff 0%, #f3fbff 100%)" },
  { id: 4, bgcolor: "linear-gradient(135deg, #fff2e9 0%, #fff8fa 100%)" },
  ...
  { id: 9, bgcolor: "linear-gradient(135deg, #f0ecf7 0%, #f7f5ff 100%)" },
